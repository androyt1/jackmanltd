...
@section('title') Who We Are @endsection
	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(architect/images/img_bg_6.jpg);">
		...
		<div id="colorlib-about">
			<div class="container">
				.<div class="row row-pb-lg">
					<div class="col-md-6">
						<div class="about animate-box">
							...
							<p>At its core, JackMan Ltd is committed to consistently delivering integrated and agile engineering and construction solutions to meet complex and evolving client needs. The foundation of our success lies in our commitment to the three tenets; “Safety, Quality, Integrity”.  When you discover JackMan Ltd, you’ll find a company ready and capable to deliver a variety of design, engineering and construction services, with a process focused on efficiency, communication, and quality control.</p>
						</div>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-4 text-center animate-box">
						<div class="staff" class="staff-img" style="background-image: url(architect/images/person3.jpg);">
							<a href="#" class="desc">
